...
export const UploadBundles = (
    ...
    try {
        let docRef =  await addDoc(collection(db, "Web_Products"), {
            ...
            release_date : new Date(convertObjToString(bundleReleaseDate)).getTime(),
        ...
        let meta_data = JSON.stringify({
            ...
            bundle_price : Number(bundleSubscriptionPrice),
            bundle_unit : Number(bundlePriceUnit),

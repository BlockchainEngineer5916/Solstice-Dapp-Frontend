                    ...
                    <Box className={classes.formDiv}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sx={{mt : '20px'}}>
                                <Button variant='contained' className={classes.buttonCss} fullWidth onClick={handleNext} disabled={formState.isValid && validateInputValue(formState.values.fullname?.replaceAll(" ", '')) ? false : true} >Next</Button>
                            </Grid>
                            <Grid item xs={12}>

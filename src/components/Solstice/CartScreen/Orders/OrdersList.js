...
const OrdersList = (props) => {
    ...
    const handlePayWithStripe = async (creator_id, creator_wallet, bidder_id, bidder_wallet, product_id, product_name, bid_id, bid_price, bid_unit, bid_amount, nft_id) => {
        ...
        let data = {
            "amount" : Number(bid_price * 100).toFixed(0),
            "currency"  : 'usd',

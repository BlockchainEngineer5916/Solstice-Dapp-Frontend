...
const useStyles = makeStyles((theme) => ({
    ...
    buttonCss : {
        color : theme.palette.green.G400 + ' !important',
    ...
    return (
        <Box className={classes.root}>
            ...
            >
                ...
                <Box className={classes.lineDiv}/>
                <DialogActions>
                    <Button variant={'outlined'} className={classes.buttonCss} onClick={handleNext} disabled={!productTypeList.length || !generalAccountTypeList.length}>Next</Button>
                </DialogActions>
            </Dialog>
        </Box>
    )
